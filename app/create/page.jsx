...
function Form() {
  const professors = [
    { id: 1, name: "Joel Vegas", image: "/Photo.png", aboutMe: "Dedicated, resourceful and goal-driven professional educator with a solid commitment to the social and academic growth and development of every child.", email: "jose@gmail.com", date: "2023-may-10", time: "05:00"  },
    { id: 2, name: "Jesse", image: "/image Circle.png",aboutMe: "I am a developer", email: "jose@gmail.com", date: "2023-may-10", time: "05:00" },
    { id: 3, name: "Nahuel", image: "/image Circle.png", aboutMe: "I am a developer", email: "jose@gmail.com", date: "2023-may-10", time: "10:00"},
    { id: 4, name: "Miguel", image: "/image Circle.png", aboutMe: "I am a developer", date: "2023-may-10", time: "9:00"},
    { id: 5, name: "Diego I", image: "/image Circle.png",aboutMe: "I am a developer", date: "2023-march-10", time: "3:00" },
    { id: 6, name: "Diego", image: "/image Circle.png", aboutMe: "I am a teacher", date: "2023-may-10", time: "08:00" },
  ];
  const userId = 1;
        ...
        />
          ...
          <ul className="mb-4 py-[1rem]">
            <li className="mb-[1rem]">
                ...
                <a href="#" className="flex items-center text-[#687684] hover:font-bold text-base md:text-lg hover:text-[#000000]"
                onClick={handleCreateCourseClick}>
                  <Image src="/Group.png" alt="Image" className="w-8 h-8" width={28}
          height={26.69}/>
            ...
            <a href="#" className="flex items-center text-[#687684] hover:font-bold text-base md:text-lg hover:text-[#000000]"
                onClick={handleUploadVideoClick}>
                 <Image src="/Film.png" alt="Image" className="w-8 h-8" width={28}
          height={26.69}/>
            ...
            <a href="#" className="flex items-center text-[#687684] hover:font-bold text-base md:text-lg hover:text-[#000000]"
                onClick={handleMyContentClick}>
                   <Image src="/Color.png" alt="Image" className="w-8 h-8" width={28}
          height={26.69}/>
  ...
  <div key={professor.id} className="relative flex items-center mb-[1rem]">
