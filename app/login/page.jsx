...
export default function Login() {
    return (
        <div className="flex text-black  py-[3.5rem]">
            ...
            <form action="" className=" w-[50%] h-[95%]">
                <div className="flex flex-col items-center justify-between w-[50%] mx-[auto]">
                    ...
                    <div className="flex flex-col w-[100%]">
                        ...
                        <label htmlFor="">
                            Username
                            <div>
                                <input type="password" placeholder="Enter you Username" className="font-light text-[0.9rem] leading-[1.3rem] py-[1rem] px-[2rem] rounded-[2.5rem] w-[100%] mt-[0.75rem] mb-[2rem]  border-2 border-[#222129]" />
                            </div>
                        </label>
                        ...
                        <label htmlFor="">
                            Password
                            <div>
                                <input type="password" placeholder="Enter you Password" className="font-light text-[0.9rem] leading-[1.3rem] py-[1rem] px-[2rem] rounded-[2.5rem] w-[100%] mt-[0.75rem] mb-[2rem] border-2 border-[#222129]" />
                            </div>
                        </label>
                    ...
                    <div className="flex w-[100%] justify-end ">
                        <button className="font-normal text-[1.125rem] leading-[1.5rem] text-white py-[0.8rem]  px-[4.5rem] bg-[#222129] rounded-[2.25rem] mt-[3.75rem]">Login</button>
                    </div>
                </div>
            </form>
        </div>
