...
export default function Offer({ title, img, description, off }) {
    console.log(off);
    return (
        <article className="w-[400px]">
            <h2>{off}</h2>
            <div className="relative ">
                    <Image className="h-[400px] object-cover" src={img} alt="img-offer" width={400}  height={600}/>
                <div className="absolute top-0 py-[2rem] pl-[2rem] pr-[6rem] bg-[#00000066] h-[400px] w-[400px] text-[#FFFFFF]">
                    <div className="bg-[#F0713D] rounded-[0.625rem] w-[100px] h-[100px] flex items-center justify-center">
                        <h3 className="font-bold text-[2.5rem] leading-[4.688rem] text-[#FFFFFF] ">30</h3>
                    </div>
