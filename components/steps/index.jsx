...
const steps = [
    {
      name: 'Smart Contract Deployment (Apr 20 ~ 27, 2023)',
      description:
...
export default function Steps() {
  return (
    <div className="mx-auto max-w-7xl  text-white px-4 sm:px-6 lg:px-8 py-16">
                ...
                {step.status === 'complete' ? (
                  <>
                    ...
                    <Link href={step.href} className="group relative flex items-start">
                      ...
                      <span className="ml-4 flex min-w-0 flex-col">
                        ...
                        <span className="text-sm dark:text-dark-txt-secondary">
                          {step.description}
                        </span>
                      </span>
                    </Link>
                  ...
                  <>
                    ...
                    >
                      ...
                      <span className="ml-4 flex min-w-0 flex-col">
                        <span className="text-sm font-medium darrk:text-dark-accent dark:text-dark-accent ">
                          {step.name}
                        </span>
                        <span className="text-sm dark:text-dark-txt-secondary">
                          {step.description}
                  ...
                  <>
                    ...
                    <Link href={step.href} className="group relative flex items-start">
                      ...
                      <span className="ml-4 flex min-w-0 flex-col">
                        <span className="text-sm font-medium dark:text-dark-txt">
                          {step.name}
                        </span>
                        <span className="text-sm dark:text-dark-txt-secondary">
                          {step.description}
