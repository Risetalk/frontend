...
export default function Register(){
    ...
    return (
        <div className="flex text-black  py-[0.5rem] h-[100vh]">
            ...
            <form action="" className=" w-[50%] h-[100%]" >
                <div className="flex flex-col items-center justify-between w-[50%] mx-[auto]">
                    ...
                    <div className="flex flex-col w-[100%]">
                        ...
                        <label htmlFor="">
                            Email
                            <div>
                                <input name="email" type="text" placeholder="Enter you Email" className="font-light text-[0.9rem] leading-[1.3rem] py-[1rem] px-[2rem] rounded-[2.5rem] w-[100%] mt-[0.75rem] mb-[0.2rem]   border-2 border-[#222129]" />
                        ...
                        <label htmlFor="">
                            Username
                            <div>
                                <input name="username" type="text" placeholder="Enter you Username" className="font-light text-[0.9rem] leading-[1.3rem] py-[1rem] px-[2rem] rounded-[2.5rem] w-[100%] mt-[0.75rem] mb-[0.2rem]   border-2 border-[#222129]" />
                                {/* onChange={()=>{console.log('handleInput')}}  */}
                            {/* <h6 className={`${errors.username === 'no' ? 'text-white' :  'text-red-400'} mb-[2rem]`}>{errors.username}</h6> */}
                            </div>
                        </label>
                        ...
                        <label htmlFor="">
                            Password
                            <div>
                                <input name="password" type="password" placeholder="Enter you Password" className="font-light text-[0.9rem] leading-[1.3rem] py-[1rem] px-[2rem] rounded-[2.5rem] w-[100%] mt-[0.75rem] mb-[0.2rem] border-2 border-[#222129]" />
                                {/* onChange={()=>{console.log('handleInput')}} */}
