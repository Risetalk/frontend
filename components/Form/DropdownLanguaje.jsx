      ...
      {isOpenLanguages && (
        <div className="absolute left-0 w-[18rem] bg-white shadow rounded-md mt-2">
          <ul className="py-2 px-4">
            <li className="text-gray-600 py-1">English</li>
            <li className="text-gray-600 py-1">French</li>
            <li className="text-gray-600 py-1">Spanish</li>
            <li className="text-gray-600 py-1">Portuguese</li>
          </ul>
        </div>
      )}
    </div>
