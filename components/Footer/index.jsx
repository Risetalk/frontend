    ...
    return (
        <footer className="flex h-40vh bg-midnight-shadow pt-8 ">
            <div className="ml-2 w-2/5 pl-8 text-white text-[0.8rem]">
                ...
                <div>
                    <input className="px-4 py-2 rounded-md border border-cloud-gray border-2 bg-transparent font-semibold text-cloud-gray placeholder:text-cloud-gray " type="text" placeholder="Subscribe to our Newsletter" />
                    <button className="m-2 px-4 py-2 rounded-md border border-cloud-gray border-2 bg-transparent font-semibold text-cloud-gray hover:bg-cloud-gray hover:text-midnight-shadow " type="submit">Subscribe</button>
                </div>
