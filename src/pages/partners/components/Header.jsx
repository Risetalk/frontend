export default function Header() {
  return (
    <div className="relative isolate py-28">
      <svg
        className="absolute inset-0 -z-10 h-full w-full dark:stroke-dark-border stroke-gray-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
      ...
      <div className="mx-auto max-w-7xl px-6 lg:flex lg:items-center lg:gap-x-10 lg:px-8 ">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <h1 className=" max-w-lg text-4xl font-bold tracking-tight dark:text-dark-txt text-gray-900 sm:text-6xl">
            Our Partners
          </h1>
