...
export default function Navbar() {
  ...
  return (
      <header
          className="bg-white shadow-navbar border-b w-full z-30 lg:overflow-y-visible dark:border-dark-second dark:bg-dark-main">
        <div
          ...
          <p className="text-sm leading-6 text-gray-900">
            <span className="font-bold">RiseCoin ICO  </span> is coming soon on the Stacks Network.{' '}
            <Link href="/" className="whitespace-nowrap font-semibold">
              Get your RCN Tokens&nbsp;<span aria-hidden="true">&rarr;</span>
            </Link>
          </p>
